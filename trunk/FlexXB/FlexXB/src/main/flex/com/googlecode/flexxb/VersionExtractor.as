...
package com.googlecode.flexxb
{
	...
	public class VersionExtractor
	{
		 ...
		 * 
		 */			
		public function VersionExtractor(versionTagName : String = "version", isElement : Boolean = false){
		 ...
		 * 
		 */			
		public function getVersion(source : XML) : String{
			var version : String;
			if(isElement){
				version = source.child(versionTagName);
			}else{
				version = source.@[versionTagName];
			}
			return version;
		}
	}
