...
package com.googlecode.flexxb.json.serializer
{
	 ...
	 * 
	 */	
	public class JSONObjectSerializer extends BaseSerializer
	{
		private static const LOG : ILogger = LogFactory.getLog(JSONObjectSerializer);
		
		public function JSONObjectSerializer(context : DescriptionContext) {
			super(context);
		}
