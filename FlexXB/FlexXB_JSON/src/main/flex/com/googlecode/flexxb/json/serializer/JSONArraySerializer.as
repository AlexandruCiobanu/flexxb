...
package com.googlecode.flexxb.json.serializer
{
	 ...
	 * 
	 */	
	public class JSONArraySerializer extends BaseSerializer
	{
		private static const LOG : ILogger = LogFactory.getLog(JSONArraySerializer);
		
		public function JSONArraySerializer(context : DescriptionContext) {
			super(context);
		}
